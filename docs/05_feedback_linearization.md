...
The outer-loop gain matrix $K$ is configured in `Controller_Design/design_nonlinear_controller.m`. The model is `Maglev_FeedbackLin.slx`, running on the EKF estimate (see [§8](08_ekf.md)).
