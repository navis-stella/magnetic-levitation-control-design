...
- **Backstepping and FeedbackLin** — empirically indistinguishable, as predicted by [§4.3](04_backstepping.md#43-relationship-to-feedback-linearization). Either is appropriate when the operating range extends beyond the linearization neighborhood and the model parameters are well known.
